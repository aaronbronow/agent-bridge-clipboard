...
console.log('2. The agent will now have the "/abc:copy", "/abc:accept", and "/abc:config" skills available.');
...
console.log('   node ~/.gemini/config/plugins/abc/skills/copy/client.js');
console.log('--------------------------------------------\n');
